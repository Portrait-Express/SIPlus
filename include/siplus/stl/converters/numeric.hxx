 ...
 * point truncation.
 */
struct SIPLUS_EXPORT int_float_converter : Converter {
 ...
 */
struct SIPLUS_EXPORT numeric_string_converter : Converter {
 ...
 */
struct SIPLUS_EXPORT numeric_bool_converter : Converter {
