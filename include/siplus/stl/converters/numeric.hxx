 ...
 * point truncation.
 */
struct SIPLUS_EXPORT int_float_converter : text::Converter {
 ...
 */
struct SIPLUS_EXPORT numeric_string_converter : text::Converter {
 ...
 */
struct SIPLUS_EXPORT numeric_bool_converter : text::Converter {
